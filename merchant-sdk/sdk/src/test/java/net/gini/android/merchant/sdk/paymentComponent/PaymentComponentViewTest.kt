...
class PaymentComponentViewTest {
    ...
    fun `calls onMoreInformation method of listener when clicking on info button`() = runTest {
        ...
        scenario?.onActivity { activity ->
            ...
            // When
            (paymentComponentView.findViewById(R.id.gms_more_information) as TextView).performClick()
            // Then
            verify {
    ...
    fun `calls onBankPickerClicked method of listener when clicking on select bank button`() = runTest {
        ...
        scenario?.onActivity { activity ->
            ...
            // When
            (paymentComponentView.findViewById(R.id.gms_select_bank_button) as Button).performClick()
    ...
    fun `does not call onPayInvoiceClicked method of listener if no document id is set`() = runTest {
        ...
        scenario?.onActivity { activity ->
            ...
            // When
            (paymentComponentView.findViewById(R.id.gms_pay_invoice_button) as Button).performClick()
...
//    }
    ...
    fun `disables buttons and deletes document id to reuse`() = runTest {
        ...
        scenario?.onActivity { activity ->
            ...
            Truth.assertThat((paymentComponentView.findViewById(R.id.gms_pay_invoice_button) as Button).isEnabled).isEqualTo(true)
            Truth.assertThat((paymentComponentView.findViewById(R.id.gms_select_bank_button) as Button).isEnabled).isEqualTo(true)
            ...
            Truth.assertThat((paymentComponentView.findViewById(R.id.gms_pay_invoice_button) as Button).isEnabled).isEqualTo(false)
            Truth.assertThat((paymentComponentView.findViewById(R.id.gms_select_bank_button) as Button).isEnabled).isEqualTo(false)
        }
    }
}