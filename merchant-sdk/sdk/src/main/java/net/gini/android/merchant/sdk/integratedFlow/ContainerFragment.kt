    ...
    private val paymentComponentListener = object: PaymentComponent.Listener {
        override fun onMoreInformationClicked() {
            ...
            childFragmentManager.beginTransaction()
                .add(binding.ghsFragmentContainerView.id, MoreInformationFragment.newInstance(paymentComponent!!, this@ContainerFragment))
        ...
        override fun onPayInvoiceClicked(documentId: String) {
            ...
            viewModel.viewModelScope.launch {
                ...
                reviewFragment?.let {
                    ...
                    childFragmentManager.beginTransaction()
                        .add(binding.ghsFragmentContainerView.id, it)
