...
htmlhelp_basename = 'GiniCaptureSDKdoc'
...
root_dokka_path = "https://developer.gini.net/gini-mobile-android/capture-sdk/sdk%(version_path)sdokka/" % {"version_path" : version_path}
root_dokka_path_default_network_library = "https://developer.gini.net/gini-mobile-android/capture-sdk/default-network%(version_path)sdokka/" % {"version_path" : version_path}

extlinks = {
    "root_dokka_path": (root_dokka_path + "%s", "%s"),
    "root_dokka_path_default_network_library": (root_dokka_path_default_network_library + "%s", "%s"),
}
