...
project = u'Gini Health API Library for Android'
...
htmlhelp_basename = 'GiniHealthAPILibraryAndroidDoc'
...
# latex_documents = [
#   ('index', 'GiniHealthAPILibraryAndroid.tex', u'Gini API Documentation',
#    u'Gini', 'manual'),
# ]
...
root_dokka_path = "https://developer.gini.net/gini-mobile-android/health-api-library/library%(version_path)sdokka/" % {"version_path" : version_path}
