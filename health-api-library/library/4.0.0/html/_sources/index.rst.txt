...
The Gini Health API Library for Android encapsulates the Gini Health API to allow you to easily integrate it into your
app.
...
.. note::
   The documentation for the 2.x.x version can be found `here. <https://developer.gini.net/gini-mobile-android/health-api-library/library/2.1.4/html/index.html>`_
