...
.. note::
   The documentation for the 1.x.x version can be found `here. <https://developer.gini.net/gini-mobile-android/health-api-library/library/1.3.0/html/index.html>`_
