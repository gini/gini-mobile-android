...
class CurrencyFormatterTest {
    ...
    fun `hasMoreThenTwoDecimalPlaces handles valid input`() {
        assertThat(hasMoreThenOneDecimalPlace("1.234")).isTrue()
        assertThat(hasMoreThenOneDecimalPlace("1,234")).isTrue()
        assertThat(hasMoreThenOneDecimalPlace("1.2")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace("1,2")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace("1.23")).isTrue()
        assertThat(hasMoreThenOneDecimalPlace("1,23")).isTrue()
        assertThat(hasMoreThenOneDecimalPlace("1")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace("1 ")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace(" 1")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace(" 1 ")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace("1,")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace("1.")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace("1,123.123")).isTrue()
        assertThat(hasMoreThenOneDecimalPlace("")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace("a")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace(".")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace(".1")).isFalse()
        assertThat(hasMoreThenOneDecimalPlace(".12")).isTrue()
        assertThat(hasMoreThenOneDecimalPlace("1.123,123")).isTrue()
    }
}
