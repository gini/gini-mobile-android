...
class HelpItemAdapter(private val context: Context): RecyclerView.Adapter<HelpItemAdapter.HelpViewHolder>() {
    ...
    override fun onBindViewHolder(holder: HelpViewHolder, position: Int) {
        ...
        val title = context.getString(tipList[position].titleTextResource)
        val description = context.getString(R.string.image_content_description_suffix, title)
        holder.iconImageView.contentDescription = description
