 ...
 * [FIXTURE_DUE_DATE]) before mid-2028, when 2028-09-01 stops being comfortably in the
 * future.
 */
object DueDateFixtures {
    ...
    /** [FIXTURE_DUE_DATE] as the sheet renders it (same pattern + locale as DueDateFormatter). */
    val FORMATTED_DUE_DATE: String =
        FIXTURE_DUE_DATE.format(DateTimeFormatter.ofPattern("dd.MM.yyyy", Locale.getDefault()))
