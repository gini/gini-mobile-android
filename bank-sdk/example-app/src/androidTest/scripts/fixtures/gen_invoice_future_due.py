...
y += 100
d.text((x, y), "Rechnung Nr. 2028-0917", font=f(40, True), fill="black")
y += 66
...
y += 110
d.text((x, y), "Zahlbar ohne Abzug bis zum 01.09.2028.", font=f(28, True), fill="black")
y += 46
d.text((x, y), "Fälligkeitsdatum: 01.09.2028", font=f(28), fill="black")
y += 70
...
y += 38
d.text((x, y), "Verwendungszweck: RE 2028-0917", font=f(26), fill="black")
