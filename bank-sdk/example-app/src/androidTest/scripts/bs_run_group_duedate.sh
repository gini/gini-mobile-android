...
#
# Every test performs a real upload + analysis round trip against the Gini API using the
# validated fixtures invoice_future_due.jpeg / invoice_no_due_date.jpeg (androidTest
# assets — copied to the device by the tests themselves, no extra media upload needed).
